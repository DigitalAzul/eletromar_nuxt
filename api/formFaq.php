...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($isDev){
        $uploaddir = 'C:\Users\x900l\Desktop\MECTRONIC\mectronic_nuxt\public\media\faq\\';
    }else{
        $uploaddir = dirname(__DIR__,1)."/media/faq/";
    }
    ...
    if ($json->emEdicao == false) {
        ...
        $sql = " INSERT INTO faq (texto, texto_en, texto_es, arquivo) VALUES ('$texto','$textoEN', '$textoES', '$ARRAY_NOME_ARQ[0]')";
        $msg = "Registro inserido com sucesso";
    } else {
        $id = $json->id;

        // FAZ CÓPIA DA imagem ORIGINAL
        $sqlCopia = "SELECT * FROM faq WHERE id = $id";
        ...
        $sql = "UPDATE faq SET texto='$texto', texto_en='$textoEN', texto_es='$textoES' $ARQUIVO  WHERE id = $id ";
