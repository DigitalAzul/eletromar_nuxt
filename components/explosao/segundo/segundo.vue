<template>
  ...
  defineProps({titulo_esquerdo:String,titulo_direito:String})
  ...
  onMounted(() => {
    ...
    let titEsq2 = document.getElementById("P-textoEsqID-Segundo");
    let titDir2 = document.getElementById("P-textoDirID-Segundo");
