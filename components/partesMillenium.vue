<template>
  <div class="x-top-16 relative flex flex-row items-center">
    ...
    >
      <div id="M-NIVEL-A" class="niveis"></div>
      <div id="M-NIVEL-B" class="niveis"></div>
      <div id="M-NIVEL-C" class="niveis"></div>
    </div>
    <div
      id="M-textoDirID"
...
onMounted(() => {
  ...
  let NAM = document.getElementById("M-NIVEL-A");
  let NBM = document.getElementById("M-NIVEL-B");
  let NCM = document.getElementById("M-NIVEL-C");
  let titEsq = document.getElementById("M-textoEsqID");
  let titDir = document.getElementById("M-textoDirID");
  ...
  window.addEventListener("scroll", () => {
    ...
    if (scrollY == 0) {
      ...
      if (scrollY < 300) {
        ...
        NAM.style.top = aTop * scrollY + "px";
        NAM.style.left = aLeft * scrollY + "px";
        NBM.style.top = 0.6 * scrollY + "px";
        NBM.style.left = 0 * scrollY + "px";
        NCM.style.top = 0.9 * scrollY + "px";
      }
    }
  });
});
